...
// */
//@Slf4j
//public class WxOAuth2WithCacheHandler extends BaseHandler {
//
...
//            throw new RuntimeException("refreshToken is null, please call the method of \"" + WxOAuth2WithCacheHandler.class.getName() + ".getOAuth2AccessToken(String appid, String secret, WxOAuth2Code wxOAuth2Code)\" to get refresh_token which should be saved in cache...");
//        String accessTokenKey = WX_OAUTH2_ACCESS_TOKEN.concat(appid).concat(secret);
...
//        if(wxCode.getErrcode() != WxCode.ERRCODE_NORMAL){
//            throw new RuntimeException("access_token is not normal, please call the method of \"" + WxOAuth2WithCacheHandler.class.getName() + ".getOAuth2AccessToken(String appid, String secret, WxOAuth2Code wxOAuth2Code) \" to get refresh_token and access_token which should be saved in cache...");
//        }
